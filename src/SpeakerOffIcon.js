    ...
    export const SpeakerOffIcon = forwardRef(({ className, style }, ref) => (
      <svg ref={ref} className={className} aria-label="speaker off, speaker, sound, sound off, off volume off, music off" style={style} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
