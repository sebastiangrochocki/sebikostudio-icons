    ...
    export const Presentation2Icon = forwardRef(({ className, style, ariaLabel, ...props }, ref) => (
      <svg ref={ref} className={className} aria-label={ariaLabel || "presentation, slides, ppt, powerpoint, file"} style={style} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
<rect x="6.5" y="10.5" width="7" height="5" stroke="currentColor" strokeLinejoin="round"/>
</svg>
