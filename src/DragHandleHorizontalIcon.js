    ...
    export const DragHandleHorizontalIcon = forwardRef(({ className, style }, ref) => (
      <svg ref={ref} className={className} aria-label="drag handle horizontal, drag handle, handle, horizontal, lines" style={style} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
