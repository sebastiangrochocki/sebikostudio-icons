    ...
    export const SpeakerQuiet2Icon = forwardRef(({ className, style }, ref) => (
      <svg ref={ref} className={className} aria-label="speaker quiet, speaker, sound, sound on, on, volume, music, quiet" style={style} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
