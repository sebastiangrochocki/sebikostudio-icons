    ...
    export const ColumnsTwoIcon = forwardRef(({ className, style, ariaLabel, ...props }, ref) => (
      <svg ref={ref} className={className} aria-label={ariaLabel || "columns two, two columns, column, containers, web content, content"} style={style} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path d="M10 15.5H1.5V4.5H10V15.5Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M18.5 15.5H10V4.5H18.5V15.5Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M1.5 1.5H2.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M1.5 18.5H2.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
