    ...
    export const SpeakerQuietIcon = forwardRef(({ className, style, ariaLabel, ...props }, ref) => (
...
<path d="M14 14C16 11.7909 16 8.20914 14 6" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
